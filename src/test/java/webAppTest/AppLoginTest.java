...
public class AppLoginTest extends BaseClassWebApp {
	...
	public static void login_empty_password() throws Exception   {
...
/*
	...
	public static void login_invalid_email_password() throws InterruptedException, Exception {
