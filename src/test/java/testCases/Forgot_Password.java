...
public class Forgot_Password extends BaseClass{
	...
	public static void Forgotpassword_Empty() throws InterruptedException {
		...
		WebElement Forgotpassword_button = driver.findElement(Forgot_PasswordPage.Forgotpassword);
		...
		Thread.sleep(2000);
		try {
			WebElement emailerror = driver.findElement(Forgot_PasswordPage.error2);
	...
	public static void Forgotpassword_invalid_Admin() throws InterruptedException {
		logger = extent.createTest("verify invalid Admin in Forgot Password", "Invalid Admin");
		Thread.sleep(2000);
		WebElement email = driver.findElement(Forgot_PasswordPage.Email);
		email.clear();
	...
	public static void Forgotpassword_Cancel() throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement Cancel = driver.findElement(Forgot_PasswordPage.Cancel);
		Cancel.click();
		Thread.sleep(2000);
	}
	...
	public static void Forgotpassword_Valid() throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.get(config.admin_forgotpass());
		Thread.sleep(3000);
