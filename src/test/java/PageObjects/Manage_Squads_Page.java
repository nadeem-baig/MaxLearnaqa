...
public class Manage_Squads_Page {
	...
	public static By Add_New_Squad = By.xpath("(//button[@type='button'])[1]");
	public static By squad_Name = By.xpath("//input[@placeholder='Type the Squad name']");
	...
	public static By Upload_Cancel = By.xpath("//div[@for='uploadImg']");

	public static By Parameter = By.xpath("(//select[@class='select_inch ml__ruleset-select categ_Secsquad-text'])[1]");
	public static By criteria = By.xpath("(//select[contains(@class,'categ_Secsquad-text')])[2]");
	...
	public static By checkbox1 = By.xpath("(//input[@type='checkbox'])[1]");
	public static By checkbox2 = By.xpath("(//input[@type='checkbox'])[2]");

	public static By Create_Squad = By.xpath("//span[@class='mr-50'][text()='Create Squad']");
	public static By Cancel_Squad = By.xpath("//a[contains(text(),'Cancel')]");
	public static By error_Message = By.xpath("//div[@class='invalid-feedback'][text()='Squad Name Required']");
