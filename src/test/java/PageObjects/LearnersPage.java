...
public class LearnersPage {
	...
	public static By Add_New_Learner = By.xpath("//span[@class='clr_tobrand'][text()='ADD NEW LEARNER']");
	public static By Heading = By.xpath("//h4[@class='ml-header__title'][text()='Manage Learners']");
...
//search
	...
	public static By Learner_Deatils_Squad_tab = By.xpath("//p[contains(text(),'Team')]");
	...
	public static By status = By.xpath("(//button[@type='button'])[2]");
